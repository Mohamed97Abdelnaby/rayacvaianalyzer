...
('extract_experience', 'Between the triple ticks you will be given a CV text extracted from PDF, Please extract the candidate work experience\n'''{CVText}'''', 'Extracts work experience from CV text'),
('calculate_experience_years', 'Between the triple ticks you will be given a job candidate work experience, Please calculate the number of years of experience\n'''{WorkExperience}'''', 'Calculates total years of experience from work experience text'),
('evaluate_candidate', 'Evaluate the candidate who has {YearsOfExperience} years of experience with the CV given between the triple ticks using the following criterias: {criteriaString} \n'''{CVText}'''', 'Evaluates candidate against specified criteria');
